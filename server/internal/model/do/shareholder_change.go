...
type ShareholderChange struct {
	...
	Gdhs            any         // 股东户数 (统计截止日的总户数)[citation:3][citation:6]
	Bh              any         // 比上期变化情况 (通常为百分比，如 -6.23 表示减少6.23%)[citation:9]
	ChangeDirection any         // 变化方向 (衍生字段)
	DataSource      any         // 数据来源 (如: 交易所公告[citation:6]、互动平台[citation:3])
