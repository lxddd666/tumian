...
// FastkData is the golang structure for table fastk_data.
type FastkData struct {
	...
	K         float64     `json:"k"         orm:"k"          description:"kst"`
	D         float64     `json:"d"         orm:"d"          description:"signal"`
