...
// QuarterlyProfitGetQuarterlyProfitInp 获取季度利润数据表数据
type QuarterlyProfitGetQuarterlyProfitInp struct {
...
func (in *QuarterlyProfitGetQuarterlyProfitInp) Filter(ctx context.Context) (err error) {
	return
}
