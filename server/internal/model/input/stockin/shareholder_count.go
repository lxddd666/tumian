...
// ShareholderCountGetShareholderCountInp 获取公司股东户数统计表数据
type ShareholderCountGetShareholderCountInp struct {
...
func (in *ShareholderCountGetShareholderCountInp) Filter(ctx context.Context) (err error) {
	return
}
