<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="股票列表核心表">
      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/stockList/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/stockList/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
          ...
          <n-button
            ...
            @click="handleExport"
            class="min-left-space"
            v-if="hasPermission(['/stockList/export'])"
          >
            <template #icon>
              <n-icon>
                <ExportOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete, Status } from '@/api/stockList';
